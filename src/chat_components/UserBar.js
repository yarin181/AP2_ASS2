...
function UserBar(props){
    ...
    const handleClick = () => {
        props.onItemClick(userInfo);
    };

    return(
         <a className={props.contact.name === props.userInfo.name ? "list-group-item list-group-item-action active" : "list-group-item list-group-item-action" } aria-current="true" onClick={handleClick}>
